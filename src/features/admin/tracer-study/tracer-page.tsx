...
import { adminTracerApi } from "./tracer.api";
import { TracerStatsCards } from "./tracer-stats-cards";
import { TracerDetailModal } from "./tracer-detail-modal";
import { TracerFormModal } from "./tracer-form-modal";
import { buildTracerColumns } from "./tracer-table";
import type {
  AdminTracerItem,
  TracerMetrics,
  TracerFilterOptions,
...
export function TracerPage() {
  ...
  const perPage = 10; // Default 10 per page sesuai arahan project leader
  ...
  return (
    <div className="space-y-6">
      {/* 1. Hero PageHeader Sesuai Desain Figma (media_1789046349470.png) */}
      <PageHeader
        variant="admin"
      ...
      {/* 2. 5 Barisan Stat Cards Sesuai Desain */}
      <TracerStatsCards
        metrics={metrics}
      ...
      <div className="rounded-3xl border border-slate-200/90 bg-white p-5 sm:p-6 shadow-xs space-y-5">
        ...
        {/* Filter & Search Toolbar (Sesuai Chat Briefing: Searchbar, Filter, Sort) */}
        ...
        {/* TanStack Data Table (10 per page) */}
        <DataTable
          columns={columns}
          data={tracerList}
          loading={loading}
      ...
      {/* 4. Modal Detail Alumni (Sesuai Mockup media_1789046357777.png) */}
      <TracerDetailModal
      ...
      {/* 5. Modal Tambah & Edit Data Tracer Study */}
      <TracerFormModal
        isOpen={isFormOpen}
