...
export const LamaranCard: React.FC<LamaranCardProps> = ({
  application,
  onOpenInstruction,
}) => {
...
export const ApplicationCard = LamaranCard;
export type ApplicationCardProps = LamaranCardProps;
