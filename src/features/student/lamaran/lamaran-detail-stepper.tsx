...
export interface LamaranDetailStepperProps {
  currentStageOrder: number;
  statusCode: string;
}

export const LamaranDetailStepper: React.FC<LamaranDetailStepperProps> = ({
  currentStageOrder,
  statusCode,
}) => {
...
export const ApplicationDetailStepper = LamaranDetailStepper;
export type ApplicationDetailStepperProps = LamaranDetailStepperProps;
